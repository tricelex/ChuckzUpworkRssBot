...
class TestDatabaseHandler(unittest.TestCase):
    def setUp(self):
        ...
        self.database_path = "resources/test.db"
        self.db = DatabaseHandler(self.database_path)
    ...
    def test_update_user(self):
        ...
        self.db.update_user(telegram_id=25525, firstname="Jonathan", is_bot=True)
        result = self.db.get_user(telegram_id=25525)
        self.assertEqual(result[0], 25525)
        self.assertEqual(result[1], "TestDummy")
    ...
    def test_remove_url_has_references(self):
        ...
        result = self.db.get_users_for_url(url="https://lorem-rss.herokuapp.com/feed")
    ...
    def test_add_user_bookmark(self):
        ...
        self.db.add_user_bookmark(
            telegram_id=25525,
            url="https://lorem-rss.herokuapp.com/feed01",
            alias="feed01",
        )
        self.db.add_user_bookmark(
            telegram_id=25525,
            url="https://lorem-rss.herokuapp.com/feed02",
            alias="feed02",
        )
        self.db.add_user_bookmark(
            telegram_id=25525,
            url="https://lorem-rss.herokuapp.com/feed03",
            alias="feed03",
        )
        ...
        self.assertEqual(result[0][0], "https://lorem-rss.herokuapp.com/feed01")
        self.assertEqual(result[1][0], "https://lorem-rss.herokuapp.com/feed02")
        self.assertEqual(result[2][0], "https://lorem-rss.herokuapp.com/feed03")
    ...
    #     filepath = os.path.join(base_path, "resources\\test.db")
    #     os.remove(filepath)
